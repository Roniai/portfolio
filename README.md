...
- In this project, we use pnpm, so install [pnpm](https://pnpm.io/installation)
- Create free account in [EmailJS](https://www.emailjs.com/)
...
First, install packages of the project :
